...
/*
poly: ugyanúgy működik, mint az std::vector
műveletek: +, -, * pontoknékt, derivátl, integrál, (resize, dft, ift, ins, del, reverse)
constans műveletek: conv, inv, log, exp, pow, sqrt, div, rem
*/