...
\inputminted[autogobble,breaklines,mathescape,linenos,numbersep=5pt,xleftmargin=0pt,fontsize=\footnotesize]{cpp}{codes/berlekamp_massey.tex}
...
\section{Extra}
\inputminted[autogobble,breaklines,mathescape,linenos,numbersep=5pt,xleftmargin=0pt,fontsize=\footnotesize]{cpp}{codes/extra.tex}

\section{Bölcsességek}

\begin{itemize}
    \item Az $O(N^2)$ $N\le 20 000$-ig jó.
    \item A bitset jó bármekkora $N$-re.
    \item Fontos a precision.
    \item Néha enni és inni is kellene.
    \item Lebegőpontos számítás???
    \item Edge case-ek fontosak.
    \item Lehet, hogy az idegeskedés nem segít.
\end{itemize}
